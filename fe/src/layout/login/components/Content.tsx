...
export default function Content() {
  ...
  return (
    <Stack sx={{flexDirection: 'column', alignSelf: 'flex-start', gap: 4, maxWidth: 450}}>
      <Box sx={{display: {xs: 'none', md: 'flex'}, color: 'text.primary', fontSize: 36, fontWeight: 'bold', alignItems: 'center'}}>
        <SitemarkIcon sx={{ height: '48px', width: '48px', ml: '40px' }}/> {t('app.name')}
      </Box>
